...
const AnalisadorCientificoRevolucionario = lazy(() => import('./components/AnalisadorCientificoRevolucionario'));
const DiscretizadorCientificoAvancado = lazy(() => import('./components/DiscretizadorCientificoAvancado'));
const AutoMLRevolucionario = lazy(() => import('./components/AutoMLRevolucionario'));
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3, flexWrap: 'wrap' }}>
            <Box>
              ...
              <Typography variant="h6" sx={{ opacity: 0.9 }}>
                Análise de Dados • Machine Learning • Visualizações • AutoML • IA Assistente
              </Typography>
            </Box>
            <FormControlLabel
              control={
